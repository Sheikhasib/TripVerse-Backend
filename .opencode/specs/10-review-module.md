...
- Rating recalculation (`TourPackage.rating`) happens in the same `prisma.$transaction` as the review insert — two separate writes here is a race condition under concurrent reviews.
